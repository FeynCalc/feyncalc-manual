...
% !TeX root = DiracAlgebraFormulas.tex

\documentclass[../FeynCalcManual.tex]{subfiles}
\begin{document}
\hypertarget{useful formulas for dirac algebra}{
\section{Useful formulas for Dirac algebra}\label{useful formulas for dirac algebra}\index{Useful formulas for Dirac algebra}}
