...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{FCFeynmanParametrize}\OperatorTok{[}\NormalTok{FAD}\OperatorTok{[\{}\FunctionTok{q}\OperatorTok{,} \FunctionTok{m}\OperatorTok{\}],} \OperatorTok{\{}\FunctionTok{q}\OperatorTok{\},} \FunctionTok{Names} \OtherTok{{-}\textgreater{}} \FunctionTok{x}\OperatorTok{,}\NormalTok{ EtaSign }\OtherTok{{-}\textgreater{}} \ConstantTok{True}\OperatorTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tmp }\ExtensionTok{=}\NormalTok{ FCFeynmanParametrize}\OperatorTok{[}\NormalTok{int}\OperatorTok{,} \OperatorTok{\{}\FunctionTok{q}\OperatorTok{\},} \FunctionTok{Names} \OtherTok{{-}\textgreater{}} \FunctionTok{x}\OperatorTok{,}\NormalTok{ FCReplaceD }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\FunctionTok{D} \OtherTok{{-}\textgreater{}} \DecValTok{4} \SpecialCharTok{{-}} \DecValTok{2}\NormalTok{ ep}\OperatorTok{\},}\NormalTok{ FeynmanIntegralPrefactor }\OtherTok{{-}\textgreater{}} \StringTok{"LoopTools"}\OperatorTok{,}\NormalTok{ EtaSign }\OtherTok{{-}\textgreater{}} \ConstantTok{True}\OperatorTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tmp }\OtherTok{/.}\NormalTok{ SMP}\OperatorTok{[}\StringTok{"Eta"}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{int }\ExtensionTok{=}\NormalTok{ SFAD}\OperatorTok{[\{\{}\FunctionTok{k}\OperatorTok{,} \SpecialCharTok{{-}}\FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{Q} \FunctionTok{k}\NormalTok{ . }\FunctionTok{n} \SpecialCharTok{{-}} \FunctionTok{k}\NormalTok{ . nb }\FunctionTok{Q}\OperatorTok{\},} \OperatorTok{\{}\SpecialCharTok{{-}}\FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{,} \DecValTok{1}\OperatorTok{\}\},} \OperatorTok{\{\{}\FunctionTok{k}\OperatorTok{,} \SpecialCharTok{{-}}\FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{Q} \FunctionTok{k}\NormalTok{ . nb }\SpecialCharTok{{-}} \FunctionTok{k}\NormalTok{ . }\FunctionTok{n} \FunctionTok{Q}\OperatorTok{\},} \OperatorTok{\{}\SpecialCharTok{{-}}\FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{,} \DecValTok{1}\OperatorTok{\}\},} \OperatorTok{\{}\FunctionTok{k}\OperatorTok{,} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{\}]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{FCFeynmanParametrize}\OperatorTok{[}\NormalTok{int}\OperatorTok{,} \OperatorTok{\{}\FunctionTok{k}\OperatorTok{\},} \FunctionTok{Names} \OtherTok{{-}\textgreater{}} \FunctionTok{x}\OperatorTok{,}\NormalTok{ FCReplaceD }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\FunctionTok{D} \OtherTok{{-}\textgreater{}} \DecValTok{4} \SpecialCharTok{{-}} \DecValTok{2}\NormalTok{ ep}\OperatorTok{\},}\NormalTok{ FinalSubstitutions }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\NormalTok{SPD}\OperatorTok{[}\NormalTok{nb}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{0}\OperatorTok{,}\NormalTok{ SPD}\OperatorTok{[}\FunctionTok{n}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{0}\OperatorTok{,}\NormalTok{ SPD}\OperatorTok{[}\NormalTok{nb}\OperatorTok{,} \FunctionTok{n}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{2}\OperatorTok{,} \FunctionTok{Q} \OtherTok{{-}\textgreater{}} \DecValTok{1}\OperatorTok{\},} 
\NormalTok{  ExtraPropagators }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\NormalTok{SFAD}\OperatorTok{[\{\{}\DecValTok{0}\OperatorTok{,} \FunctionTok{n}\NormalTok{ . }\FunctionTok{k}\OperatorTok{\},} \OperatorTok{\{}\DecValTok{0}\OperatorTok{,} \SpecialCharTok{+}\DecValTok{1}\OperatorTok{\},}\NormalTok{ al}\OperatorTok{\}]\}]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{DataType}\OperatorTok{[}\FunctionTok{m}\OperatorTok{,}\NormalTok{ FCVariable}\OperatorTok{]} \ExtensionTok{=} \ConstantTok{True}\NormalTok{;}
\NormalTok{DataType}\OperatorTok{[}\FunctionTok{Q}\OperatorTok{,}\NormalTok{ FCVariable}\OperatorTok{]} \ExtensionTok{=} \ConstantTok{True}\NormalTok{;}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{FCFeynmanParametrize}\OperatorTok{[}\NormalTok{SFAD}\OperatorTok{[}\FunctionTok{k} \SpecialCharTok{{-}}\NormalTok{ pb}\OperatorTok{,} \FunctionTok{k} \SpecialCharTok{+} \FunctionTok{p}\OperatorTok{,} \OperatorTok{\{}\FunctionTok{k}\OperatorTok{,} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{\}],} \OperatorTok{\{}\FunctionTok{k}\OperatorTok{\},} \FunctionTok{Names} \OtherTok{{-}\textgreater{}} \FunctionTok{x}\OperatorTok{,}\NormalTok{ FCReplaceD }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\FunctionTok{D} \OtherTok{{-}\textgreater{}} \DecValTok{4} \SpecialCharTok{{-}} \DecValTok{2}\NormalTok{ ep}\OperatorTok{\},}\NormalTok{ FinalSubstitutions }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\NormalTok{SPD}\OperatorTok{[}\NormalTok{nb}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{0}\OperatorTok{,}\NormalTok{ SPD}\OperatorTok{[}\FunctionTok{n}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{0}\OperatorTok{,}\NormalTok{ SPD}\OperatorTok{[}\NormalTok{nb}\OperatorTok{,} \FunctionTok{n}\OperatorTok{]} \OtherTok{{-}\textgreater{}} \DecValTok{2}\OperatorTok{,} \FunctionTok{Q} \OtherTok{{-}\textgreater{}} \DecValTok{1}\OperatorTok{\},} 
\NormalTok{  ExtraPropagators }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\NormalTok{SFAD}\OperatorTok{[\{\{}\DecValTok{0}\OperatorTok{,} \FunctionTok{n}\NormalTok{ . }\FunctionTok{k}\OperatorTok{\},} \OperatorTok{\{}\DecValTok{0}\OperatorTok{,} \SpecialCharTok{+}\DecValTok{1}\OperatorTok{\},}\NormalTok{ al}\OperatorTok{\}]\},}\NormalTok{ FCReplaceMomenta }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\FunctionTok{p} \OtherTok{{-}\textgreater{}}\NormalTok{ (}\FunctionTok{Q} \FunctionTok{n}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{+} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{Q}\NormalTok{ nb}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\OperatorTok{,}\NormalTok{ pb }\OtherTok{{-}\textgreater{}}\NormalTok{ (}\FunctionTok{Q}\NormalTok{ nb}\SpecialCharTok{/}\DecValTok{2} \SpecialCharTok{+} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{Q} \FunctionTok{n}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\OperatorTok{\}]}
\end{Highlighting}
\end{Shaded}
