...
\section{FCPartialD}\label{fcpartiald}\index{FCPartialD}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{QuantumField}\OperatorTok{[}\NormalTok{FCPartialD}\OperatorTok{[}\NormalTok{FCGV}\OperatorTok{[}\StringTok{"}\SpecialCharTok{\textbackslash{}[}\StringTok{Del]"}\OperatorTok{]],} \FunctionTok{S}\OperatorTok{,} \FunctionTok{x}\OperatorTok{]}
\end{Highlighting}
\end{Shaded}
