...
\item
  ...
  \hyperlink{../fcvariable}{../FCVariable} - various datatypes
\item
...
\tightlist
\item
  \hyperlink{../abbreviation}{../Abbreviation},
...
\item
  ...
  \hyperlink{../typesettingdime}{../\$TypesettingDimE} - typesetting of
  tensors in \(4\), \(D\) and \(D-4\) dimensions
\item
...
\section{Lorentz and Cartesian
tensors}\label{lorentz-and-cartesian-tensors}}
...
\section{Algebra of noncommutative
objects}\label{algebra-of-noncommutative-objects}}
...
\hypertarget{sun-algebra}{%
\section{\texorpdfstring{\(SU(N)\)
algebra}{SU(N) algebra}}\label{sun-algebra}}
...
\item
  \hyperlink{../fcgreterminant}{../FCGramDeterminant} - calculates the
  Gram determinant
\item
...
\item
  \hyperlink{../fcloopbasispropagatorstotopology}{../FCLoopBasisPropagatorsToTopology}
...
\section{Feynman rules and
amplitudes}\label{feynman-rules-and-amplitudes}}
...
\tightlist
\item
  \hyperlink{../disablememset}{../\$DisableMemSet},
  \hyperlink{../fapatch}{../\$FAPatch},
  \hyperlink{../fccheckcontext}{../\$FCCheckContext},
  \hyperlink{../fccloudtraditionalform}{../\$FCCloudTraditionalForm},
  \hyperlink{../fctraditionalformoutput}{../\$FCTraditionalFormOutput},
  \hyperlink{../feynartsdirectory}{../\$FeynArtsDirectory},
  \hyperlink{../feyncalcdevelopmentversion}{../\$FeynCalcDevelopmentVersion},
  \hyperlink{../feyncalcdirectory}{../\$FeynCalcDirectory},
  \hyperlink{../feyncalcstartupmessages}{../\$FeynCalcStartupMessages},
  \hyperlink{../loadaddons}{../\$LoadAddOns},
  \hyperlink{../multiplications}{../\$Multiplications},
  \hyperlink{../renamefeyncalcobjects}{../\$RenameFeynCalcObjects} -
  global switches that can be set before loading FeynCalc
\item
  \hyperlink{../containers}{../\$Containers},
  \hyperlink{../distributivefunctions}{../\$DistributiveFunctions},
  \hyperlink{../disablememset}{../\$DisableMemSet},
  \hyperlink{../fcadvice}{../\$FCAdvice},
  \hyperlink{../fcmemoryavailable}{../\$FCMemoryAvailable},
  \hyperlink{../fcshowieta}{../\$FCShowIEta},
  \hyperlink{../fortrancontinuationcharacter}{../\$FortranContinuationCharacter},
  \hyperlink{../keeplogdivergentscalelessintegrals}{../\$KeepLogDivergentScalelessIntegrals},
  \hyperlink{../levicivitasign}{../\$LeviCivitaSign}
  \hyperlink{../limitto4}{../\$LimitTo4},
  \hyperlink{../limitto4irunsafe}{../\$LimitTo4IRUnsafe},
  \hyperlink{../veryverbose}{../\$VeryVerbose},
  \hyperlink{../fapatch}{../\$FAPatch} - global switches that can be
  changed during the operation of FeynCalc
\item
  \hyperlink{../abbreviations}{../\$Abbreviations},
  \hyperlink{../al}{../\$AL},
  \hyperlink{../fctensorlist}{../\$FCTensorList},
  \hyperlink{../feyncalcversion}{../\$FeynCalcVersion},
  \hyperlink{../mu}{../\$MU}, \hyperlink{../noncomm}{../\$NonComm},
  \hyperlink{../scalarproducts}{../\$ScalarProducts} - global variables
  needed for the proper functioning of FeynCalc
\item
...
\item
  ...
  \hyperlink{../mintegrate}{../\$MIntegrate},
  \hyperlink{../opeward}{../\$OPEWard}, \hyperlink{../ope}{../OPE},
  \hyperlink{../ope1loop}{../OPE1Loop},
...
\section{Deprecated or legacy
functions}\label{deprecated-or-legacy-functions}}
...
\item
  \hyperlink{../breitmaison}{../\$BreitMaison},
  \hyperlink{../larin}{../\$Larin} - use
...
\item
  \hyperlink{../loadfeynarts}{../\$LoadFeynArts},
  \hyperlink{../loadphi}{../\$LoadPhi},
  \hyperlink{../loadtarcer}{../\$LoadTARCER} - use
  \hyperlink{../loadaddons}{../\$LoadAddOns}
\item
