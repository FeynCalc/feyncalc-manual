...
\CommentTok{(*FeynAmpDenominator[CartesianPropagatorDenominator[CartesianMomentum[p1, {-}1 + D], 2 CartesianPair[CartesianMomentum[p1, {-}1 + D], CartesianMomentum[p2, {-}1 + D]], m\^{}2, \{2, {-}1\}]]*)}
\end{Highlighting}
\end{Shaded}
