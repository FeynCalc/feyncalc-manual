...
% !TeX root = PaVeReduce.tex

\documentclass[../FeynCalcManual.tex]{subfiles}
\begin{document}
\hypertarget{pavereduce}{
\section{PaVeReduce}\label{pavereduce}\index{PaVeReduce}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PaVeReduce}\OperatorTok{[}\NormalTok{PaVe}\OperatorTok{[}\DecValTok{1}\OperatorTok{,} \DecValTok{2}\OperatorTok{,} \OperatorTok{\{}\FunctionTok{s}\OperatorTok{,} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{,} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{\},} \OperatorTok{\{}\FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{,} \FunctionTok{m}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{,} \FunctionTok{M}\SpecialCharTok{\^{}}\DecValTok{2}\OperatorTok{\}],}\NormalTok{ IsolateNames }\OtherTok{{-}\textgreater{}}\NormalTok{ FF}\OperatorTok{]} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{PaVeReduce}\OperatorTok{[}\NormalTok{PaVe}\OperatorTok{[}\DecValTok{2}\OperatorTok{,} \OperatorTok{\{}\NormalTok{SmallVariable}\OperatorTok{[}\NormalTok{me2}\OperatorTok{],}\NormalTok{ mw2}\OperatorTok{,} \FunctionTok{t}\OperatorTok{\},} \OperatorTok{\{}\NormalTok{SmallVariable}\OperatorTok{[}\NormalTok{me2}\OperatorTok{],} \DecValTok{0}\OperatorTok{,}\NormalTok{ mw2}\OperatorTok{\}],}
\NormalTok{   WriteOutPaVe }\OtherTok{{-}\textgreater{}} \StringTok{"p"}\OperatorTok{]} 
 
\FunctionTok{TableForm}\OperatorTok{[}\FunctionTok{ReadList}\OperatorTok{[}\StringTok{"pPaVe1Cmw2tsmame2C0mw2smame2.s"}\OperatorTok{,} \FunctionTok{String}\OperatorTok{]]} 
 
\FunctionTok{DeleteFile} \SpecialCharTok{/}\NormalTok{@ }\FunctionTok{FileNames}\OperatorTok{[}\StringTok{"pPaVe1Cmw2tsmame2C0mw2smame2.s"}\OperatorTok{]}\NormalTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{se }\ExtensionTok{=}\NormalTok{ SmallVariable}\OperatorTok{[}\NormalTok{ME2}\OperatorTok{]}\NormalTok{; }
 
\NormalTok{d122 }\ExtensionTok{=}\NormalTok{ PaVeReduce}\OperatorTok{[}\NormalTok{PaVe}\OperatorTok{[}\DecValTok{1}\OperatorTok{,} \DecValTok{2}\OperatorTok{,} \DecValTok{2}\OperatorTok{,} \OperatorTok{\{}\NormalTok{se}\OperatorTok{,}\NormalTok{ MW2}\OperatorTok{,}\NormalTok{ MW2}\OperatorTok{,}\NormalTok{ se}\OperatorTok{,} \FunctionTok{S}\OperatorTok{,} \FunctionTok{T}\OperatorTok{\},} \OperatorTok{\{}\DecValTok{0}\OperatorTok{,}\NormalTok{ se}\OperatorTok{,} \DecValTok{0}\OperatorTok{,}\NormalTok{ se}\OperatorTok{\}],}\NormalTok{ Mandelstam }\OtherTok{{-}\textgreater{}} \OperatorTok{\{}\FunctionTok{S}\OperatorTok{,} \FunctionTok{T}\OperatorTok{,} \FunctionTok{U}\OperatorTok{,} \DecValTok{2}\NormalTok{ MW2}\OperatorTok{\},}\NormalTok{ IsolateNames }\OtherTok{{-}\textgreater{}} \FunctionTok{F}\OperatorTok{]} \SpecialCharTok{//}\NormalTok{ FRH }
 
\NormalTok{Write2}\OperatorTok{[}\StringTok{"fctd122.for"}\OperatorTok{,}\NormalTok{ d122res }\ExtensionTok{==}\NormalTok{ d122}\OperatorTok{,} \FunctionTok{FormatType} \OtherTok{{-}\textgreater{}} \FunctionTok{FortranForm}\OperatorTok{]}\NormalTok{; }
 
\FunctionTok{TableForm}\OperatorTok{[}\FunctionTok{ReadList}\OperatorTok{[}\StringTok{"fctd122.for"}\OperatorTok{,} \FunctionTok{String}\OperatorTok{]]} 
 
\FunctionTok{DeleteFile} \SpecialCharTok{/}\NormalTok{@ }\FunctionTok{FileNames}\OperatorTok{[}\StringTok{"fctd122.for"}\OperatorTok{]}\NormalTok{; }\FunctionTok{Clear}\OperatorTok{[}\NormalTok{d122}\OperatorTok{,}\NormalTok{ se}\OperatorTok{]}\NormalTok{; }
\end{Highlighting}
\end{Shaded}
