...
\begin{document}
\hypertarget{smp}{
\section{SMP}\label{smp}\index{SMP}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SMP}\OperatorTok{[}\StringTok{"m\_e"}\OperatorTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SMP}\OperatorTok{[}\StringTok{"g\_W"}\OperatorTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SMP }\SpecialCharTok{/}\NormalTok{@ }\FunctionTok{Last} \SpecialCharTok{/}\NormalTok{@ SMP}\OperatorTok{[]}
\end{Highlighting}
\end{Shaded}
